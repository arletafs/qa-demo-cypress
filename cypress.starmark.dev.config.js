...
module.exports = defineConfig({
  ...
  e2e: {
    environment: 'dev',
    targetSite: "starmark",
    baseUrl: 'https://starmark-dev.seez.dk/',
    searchPage: 'https://starmark-dev.seez.dk/soegeresultater/',
    searchPageWholesale: 'https://starmark-dev.seez.dk/soegeresultater/engros',
    currency: 'kr',
    currencyStyled: 'DKK',
